...
DATASETS = {
    ...
    "random-xs-20-euclidean": lambda out_fn: random_float(out_fn, 20, 100000, 100, "euclidean"),
    "random-s-40-euclidean": lambda out_fn: random_float(out_fn, 40, 100000, 100, "euclidean"),
    "random-s-60-euclidean": lambda out_fn: random_float(out_fn, 60, 100000, 100, "euclidean"),
    "random-s-100-euclidean": lambda out_fn: random_float(out_fn, 100, 1010000, 100, "euclidean"),
    "random-s-128-euclidean": lambda out_fn: random_float(out_fn, 128, 510000, 100, "euclidean"),
    "random-s-1024-euclidean": lambda out_fn: random_float(out_fn, 1024, 1010000, 100, "euclidean"),
    "random-s-1536-euclidean": lambda out_fn: random_float(out_fn, 1536, 510000, 100, "euclidean"),
    "random-s-2048-euclidean": lambda out_fn: random_float(out_fn, 2048, 1010000, 100, "euclidean"),
    "random-s-4096-euclidean": lambda out_fn: random_float(out_fn, 4096, 1010000, 100, "euclidean"),
    "random-s-8192-euclidean": lambda out_fn: random_float(out_fn, 8192, 1010000, 100, "euclidean"),
    "random-s-968-euclidean": lambda out_fn: random_float(out_fn, 968, 1010000, 100, "euclidean"),
    "random-s-768-euclidean": lambda out_fn: random_float(out_fn, 768, 510000, 100, "euclidean"),
    "random-s-786-euclidean": lambda out_fn: random_float(out_fn, 786, 1010000, 100, "euclidean"),
    "random-s-512-euclidean": lambda out_fn: random_float(out_fn, 512, 510000, 100, "euclidean"),
    "random-s-256-euclidean": lambda out_fn: random_float(out_fn, 256, 1010000, 100, "euclidean"),
